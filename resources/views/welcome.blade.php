...
<body class="bg-gray-900 text-gray-100" x-data="portfolio()" x-init="init()" x-bind:class="{ 'overflow-hidden': mobileMenuOpen }">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex gap-4">
                    ...
                    @endif
                    @if($profile?->twitter)
                    <a href="{{ $profile->twitter }}" target="_blank" class="text-gray-400 hover:text-white transition">X</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <a href="https://wa.me/{{ $profile->whatsapp }}" target="_blank" rel="noopener noreferrer"
       class="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full shadow-lg transition-transform hover:scale-110"
